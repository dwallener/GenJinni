...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--ss_recursion_prob', type=float, default=0.001, help='probability, at a given step, to use the previous step\'s generated frame as input image')
